    ...
    static class Program
    {
        ...
        private static void LoadConfig()
        {
            if (!System.IO.File.Exists(@"config.ini"))
            {
                ...
                System.IO.StreamWriter cfg_file = new System.IO.StreamWriter(@"config.ini");
                cfg_file.WriteLine("Host=localhost");
                cfg_file.WriteLine("DB=mangos");
                cfg_file.WriteLine("User=root");
                cfg_file.WriteLine("Pass=root");
                cfg_file.WriteLine("Highlight=true");
                cfg_file.Close();
